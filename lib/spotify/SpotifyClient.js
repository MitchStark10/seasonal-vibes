...
export class SpotifyClient {
  ...
  async createPlaylist({ playlistName, playlistVisibilityType }) {
    const newPlaylistBody = {
      name: playlistName,
      public: playlistVisibilityType === "public",
    };
  ...
  async createScheduledPlaylist({ playlistName, playlistVisibilityType }) {
    if (!this.userEmail) {
